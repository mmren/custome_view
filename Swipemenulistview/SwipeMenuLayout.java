package com.zd.myd.custome_view.Swipemenulistview;
...
public class SwipeMenuLayout extends FrameLayout {
	...
	public boolean onSwipe(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			int dis = Math.abs((int) (mDownX - event.getX()));
			int dis_y= Math.abs((int) (mDownY - event.getY()));
			Log.i("byz","=================="+dis+"================"+dis_y);
	...
	public  boolean end(){
		if ((isFling || Math.abs(mDownX - mEvent.getX()) > (mMenuView.getWidth() / 2)) &&
				Math.signum(mDownX - mEvent.getX()) == mSwipeDirection) {
			// open
			smoothOpenMenu();
		} else {
			// close
